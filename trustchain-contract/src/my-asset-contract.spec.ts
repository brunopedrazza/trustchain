...
describe('MyAssetContract', () => {
    ...
    let contract: ContractController;
    let ctx: TestContext;
    ...
    describe('#myAssetExists', () => {
        ...
        it('should return true for a my asset', async () => {
            await contract.contractExists(ctx, '1001').should.eventually.be.true;
        });

        it('should return false for a my asset that does not exist', async () => {
            await contract.contractExists(ctx, '1003').should.eventually.be.false;
        });
    ...
    describe('#createMyAsset', () => {
        ...
        it('should create a my asset', async () => {
            //await contract.CreateContract(ctx, '1003', 'my asset 1003 value');
